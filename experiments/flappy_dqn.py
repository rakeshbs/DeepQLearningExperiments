...
Uses 6 Ape-X actors with a 5-dim state observation (no pixels).
...
Train:  python -m experiments.flappy_dqn
Test:   python -m experiments.flappy_dqn --test [--best]
"""
...
runner = ParallelRunner(
    ...
    epsilon_base=0.4,         # starting base for the Ape-X epsilon spread; decays over training
